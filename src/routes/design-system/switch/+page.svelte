...
<div class="flex flex-col gap-8">
  ...
  <p class="text-neutral-11">
    A beautiful glowing toggle component using <code>@utility switch-group</code>,
    <code>@utility switch-label</code>, and <code>@utility switch-description</code>.
  </p>
    ...
    <div class="mt-4 flex flex-col gap-6 card-content">
      ...
      <label class="switch-group">
        ...
        <div>
          ...
          <div class="switch-description">Increase visibility of selected layers and tools.</div>
        </div>
      </label>
    </div>
  </div>
  ...
  <div class="mt-8">
    ...
    <Code label="switch.html" code={usageCode} lang="html" />
  </div>
</div>
