...
export const playground_check: (a: number, b: number) => void;
export const playground_compile: (a: number, b: number) => void;
export const playground_getVersion: (a: number, b: number) => void;
